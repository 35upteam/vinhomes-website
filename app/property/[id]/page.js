...
export default function PropertyDetail() {
  ...
  const handleDownloadPoster = async () => {
    ...
    try {
      ...
      // Chụp mồi để ép iPhone tải ảnh Base64 vào RAM
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 flex flex-col relative pb-20 md:pb-0 overflow-x-hidden">
      ...
      {/* VÙNG POSTER DÀNH RIÊNG CHO IOS (VIEWPORT RENDER - ẨN BẰNG OPACITY 0.01) */}
      <div style={{ position: 'fixed', top: 0, left: 0, opacity: 0.01, zIndex: -9999, pointerEvents: 'none' }}>
        <div 
          ref={posterRef}
          style={{ 
            width: '1200px', 
        ...
        >
          <div style={{ display: 'flex', width: '100%', height: '100%', backgroundColor: '#ffffff', overflow: 'hidden' }}>
             ...
             <div style={{ width: '50%', height: '100%', position: 'relative', backgroundColor: '#e5e7eb' }}>
                <img 
                  src={coverBase64 !== '/banner.jpg' ? coverBase64 : (images.length > 0 ? optimizePosterImg(images[0]) : '/banner.jpg')} 
                  alt="Cover" 
                  width="600"
                  height="630"
