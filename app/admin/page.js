...
export default function AdminPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // THÔNG SỐ CLOUDINARY CỦA BẠN ĐÃ ĐƯỢC THÊM VÀO ĐÂY
      const CLOUD_NAME = "ibzfmsqp"; 
      const UPLOAD_PRESET = "upload preset";

      // Vòng lặp đẩy ảnh lên Cloudinary
      for (const file of images) {
        ...
        imageUrls.push(uploadedImage.secure_url); // Lấy link ảnh Cloudinary trả về
      }

      // Đẩy thông tin văn bản và link ảnh vào Firebase
      ...
      alert('Có lỗi xảy ra, vui lòng kiểm tra lại cấu hình!');
    }
