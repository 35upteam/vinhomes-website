          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-5">
              <div>
                ...
                <select className="w-full p-2 border border-gray-200 rounded text-sm focus:outline-none text-gray-700">
              ...
              <div key={item.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                 ...
                 <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      <a href={`tel:${CONTACT_PHONE}`} className="flex-1 border border-gray-300 text-gray-700 hover:bg-gray-50 text-center py-2 rounded text-sm font-semibold transition">
                         Liên hệ
                      </a>
                      <a href={`https://zalo.me/${CONTACT_PHONE}`} target="_blank" rel="noreferrer" className="flex-1 bg-[#b8955a] hover:bg-[#a07d46] text-white text-center py-2 rounded text-sm font-semibold transition">
                         Zalo
                      </a>
                    </div>
                 </div>
